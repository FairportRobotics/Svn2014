 ...
 * @author Tyler
 */
public class LoadBallCommand extends CommandGroup {
    ...
    public LoadBallCommand() {
        ...
        addSequential(new BoomSpinCommand(1500, 1), 1);
        addSequential(new BoomRetractCommand(), 2);
        addSequential(new BoomExtendCommand(), 5);
